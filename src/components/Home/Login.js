...
const Login = () => {
    ...
    const setData = (event) => {
        ...
        if (id === 'floatingPassword') {
            setLogin(prevData => ({...prevData, passord: data}));
    ...
    const handleSignIn = (e) => {
        ...
        ApiService.login(login)
            .then(resp => {
               ...
               // localStorage.setItem('user1',JSON.stringify(user.id));
               
                setError(null);
               // document.write(user.role+"+++++++++");
                if (user.email==="su@gmail.com" || user.email==="sw@gmail.com") // then it's a librarian
                  ...
                  <div className="col-md-9 col-lg-8 mx-auto my-container">
                    ...
                    <form>
                      ...
                      <div className="d-grid">
                        <Link to="/"><button type="submit" className="btn btn-lg btn-primary btn-login mb-2" onClick={handleSignIn}>Sign in</button></Link>
                        ...
                        <div className="text-center">
                         ...
                         <br></br>
                          <Link to="/forgetpassword" style={{textDecoration: "none"}}><span id="register-here">forget Password</span></Link> 
                        </div>
                      </div>
