        ...
        <div>
            <nav className={`navbar fixed-top navbar-expand-md navbar-dark ${location.pathname==='/'? 'bg-transparent': 'bg-dark'}`} aria-label="Navbar">
                <div className="container">
                    <Link to="/" className="navbar-brand" ><span><i className="fa fa-h-book me-2" aria-hidden="true"/>AspiringReads</span></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarsExample04">
                        <ul className="navbar-nav me-auto mb-2 mb-md-0">
                            ...
                            <Link to="/features" className="nav-link px-2 text-white"><li>Features</li></Link>
                        ...
                        { user ?
                            ...
                            (<div className="text-end">
                                ...
                                <Link to="/"><button type="button" className="btn btn-outline-light me-2">Logout</button></Link>
